...
这是一个 Claude Code Plugin 仓库。当你在这个目录下工作时，遵循以下规则。

## 目录约定

- `skills/<name>/SKILL.md` — 技能定义，目录名必须与 SKILL.md 中的 `name` 字段一致
...
4. 更新 `CHANGELOG.md`（Add 条目）
5. `git commit`

## 版本号

- 插件级版本在 `.claude-plugin/plugin.json` 中
