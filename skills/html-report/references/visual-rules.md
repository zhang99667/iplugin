...
| 需要内部审阅的报告 | 正常报告结构 + 离线评论模式 | 选区提问/批注、右侧栏、内嵌评论包、Markdown 兜底、导出发布版 |
